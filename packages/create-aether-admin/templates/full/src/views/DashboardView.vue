    ...
    <div class="space-y-6 p-8">
      ...
      <div class="grid gap-6 xl:grid-cols-[1fr_360px]">
        <AetherCard
          ...
          description="A quiet analytical surface with minimal chrome and strong whitespace."
        >
        ...
        <AetherCard title="Activity" description="Recent workflow changes">
          <div class="space-y-4">
            ...
            >
              <div
                class="mt-1 flex size-8 shrink-0 items-center justify-center rounded-full bg-admin-primary-soft text-admin-primary"
              >
      ...
      <AetherCard title="Capacity" description="Dense but readable progress display.">
        <div class="grid gap-5 md:grid-cols-3">
          <div
            v-for="item in [
              { label: 'API quota', value: 72 },
              { label: 'Storage', value: 48 },
              { label: 'Automation', value: 86 },
            ]"
            :key="item.label"
          >
